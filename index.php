...
<!-- <div id="canvas-overlay"></div> -->
	<div class="boxed-page">
        <div id="nave" style="display:flex;  justify-content: space-around;  padding: 30px 0px;">
            ...
            <a class="btn btn-primary btn-shadow btn-lg" href="login.php" role="button">login</a>
        </div>
    <!-- </div> -->
<div class="hero">
  <div class="container">
...
<section id="gtco-welcome" class="bg-white section-padding">
    <div class="container">
        <div class="section-content">
            <div class="row">
                <div class="col-sm-5 img-bg d-flex shadow align-items-center justify-content-center justify-content-md-end img-2" style="background-image: url(img/resto1.jpg);">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <a href="#" class="thumb-menu">
                                    <img class="img-fluid img-cover" src="img/plate2.jpeg" />
                                    <h6>Australian Organic Beef</h6>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="thumb-menu">
                                    <img class="img-fluid img-cover" src="img/salmon-zucchini.jpg" />
                                    <h6>Australian Organic Beef</h6>
                                </a>
                            </div>
                            <div class="col-4">
                                <a href="#" class="thumb-menu">
                                    <img class="img-fluid img-cover" src="img/desire.jpg"/>
                                    <h6>Australian Organic Beef</h6>
                                </a>
                            </div>
                        </div>
                    ...
                    <form method="post" name="contact-us" action="">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <input type="text" class="form-control" id="name" name="Titre" placeholder="Name">
                            </div>
                            <div class="col-md-12 form-group">
